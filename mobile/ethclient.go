...
// Contains a wrapper for the Hotelbyte client.
...
// HotelbyteClient provides access to the Hotelbyte APIs.
type HotelbyteClient struct {
	client *ethclient.Client
}

// NewHotelbyteClient connects a client to the given URL.
func NewHotelbyteClient(rawurl string) (client *HotelbyteClient, _ error) {
	rawClient, err := ethclient.Dial(rawurl)
	return &HotelbyteClient{rawClient}, err
}

// GetBlockByHash returns the given full block.
func (ec *HotelbyteClient) GetBlockByHash(ctx *Context, hash *Hash) (block *Block, _ error) {
...
func (ec *HotelbyteClient) GetBlockByNumber(ctx *Context, number int64) (block *Block, _ error) {
	if number < 0 {
...
func (ec *HotelbyteClient) GetHeaderByHash(ctx *Context, hash *Hash) (header *Header, _ error) {
...
func (ec *HotelbyteClient) GetHeaderByNumber(ctx *Context, number int64) (header *Header, _ error) {
	if number < 0 {
...
func (ec *HotelbyteClient) GetTransactionByHash(ctx *Context, hash *Hash) (tx *Transaction, _ error) {
...
func (ec *HotelbyteClient) GetTransactionSender(ctx *Context, tx *Transaction, blockhash *Hash, index int) (sender *Address, _ error) {
...
func (ec *HotelbyteClient) GetTransactionCount(ctx *Context, hash *Hash) (count int, _ error) {
...
func (ec *HotelbyteClient) GetTransactionInBlock(ctx *Context, hash *Hash, index int) (tx *Transaction, _ error) {
...
func (ec *HotelbyteClient) GetTransactionReceipt(ctx *Context, hash *Hash) (receipt *Receipt, _ error) {
...
func (ec *HotelbyteClient) SyncProgress(ctx *Context) (progress *SyncProgress, _ error) {
...
func (ec *HotelbyteClient) SubscribeNewHead(ctx *Context, handler NewHeadHandler, buffer int) (sub *Subscription, _ error) {
...
func (ec *HotelbyteClient) GetBalanceAt(ctx *Context, account *Address, number int64) (balance *BigInt, _ error) {
	if number < 0 {
...
func (ec *HotelbyteClient) GetStorageAt(ctx *Context, account *Address, key *Hash, number int64) (storage []byte, _ error) {
	if number < 0 {
...
func (ec *HotelbyteClient) GetCodeAt(ctx *Context, account *Address, number int64) (code []byte, _ error) {
	if number < 0 {
...
func (ec *HotelbyteClient) GetNonceAt(ctx *Context, account *Address, number int64) (nonce int64, _ error) {
	if number < 0 {
...
func (ec *HotelbyteClient) FilterLogs(ctx *Context, query *FilterQuery) (logs *Logs, _ error) {
...
func (ec *HotelbyteClient) SubscribeFilterLogs(ctx *Context, query *FilterQuery, handler FilterLogsHandler, buffer int) (sub *Subscription, _ error) {
	// Subscribe to the event internally
...
func (ec *HotelbyteClient) GetPendingBalanceAt(ctx *Context, account *Address) (balance *BigInt, _ error) {
...
func (ec *HotelbyteClient) GetPendingStorageAt(ctx *Context, account *Address, key *Hash) (storage []byte, _ error) {
...
func (ec *HotelbyteClient) GetPendingCodeAt(ctx *Context, account *Address) (code []byte, _ error) {
...
func (ec *HotelbyteClient) GetPendingNonceAt(ctx *Context, account *Address) (nonce int64, _ error) {
...
func (ec *HotelbyteClient) GetPendingTransactionCount(ctx *Context) (count int, _ error) {
...
func (ec *HotelbyteClient) CallContract(ctx *Context, msg *CallMsg, number int64) (output []byte, _ error) {
	if number < 0 {
...
func (ec *HotelbyteClient) PendingCallContract(ctx *Context, msg *CallMsg) (output []byte, _ error) {
	return ec.client.PendingCallContract(ctx.context, msg.msg)
}

// SuggestGasPrice retrieves the currently suggested gas price to allow a timely
// execution of a transaction.
func (ec *HotelbyteClient) SuggestGasPrice(ctx *Context) (price *BigInt, _ error) {
...
func (ec *HotelbyteClient) EstimateGas(ctx *Context, msg *CallMsg) (gas int64, _ error) {
...
func (ec *HotelbyteClient) SendTransaction(ctx *Context, tx *Transaction) error {
