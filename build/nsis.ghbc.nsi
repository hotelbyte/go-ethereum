...
# 1. install ghbc for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for ghbc
# 5. create ghbc, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable HOTELBYTE_SOCKET
...
!define APPNAME "Ghbc"
!define DESCRIPTION "Official Go implementation of the Hotelbyte protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since ghbc is installed global
