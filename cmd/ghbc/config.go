...
func loadConfig(file string, cfg *ghbcConfig) error {
	f, err := os.Open(file)
	if err != nil {
		return err
	}
...
func defaultNodeConfig() node.Config {
	...
	cfg.IPCPath = "ghbc.ipc"
	return cfg
}

func makeConfigNode(ctx *cli.Context) (*node.Node, ghbcConfig) {
	// Load defaults.
	cfg := ghbcConfig{
...
func makeFullNode(ctx *cli.Context) *node.Node {
	...
	// Add the Hotelbyte Stats daemon if requested.
	if cfg.Ethstats.URL != "" {
