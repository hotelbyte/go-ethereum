...
// DefaultConfig contains default settings for use on the Hotelbyte main net.
...
func init() {
	...
	if runtime.GOOS == "windows" {
		...
		DefaultConfig.Ethash.DatasetDir = filepath.Join(home, ".hotelbyte")
	}
}
...
type Config struct {
	...
	// If nil, the Hotelbyte main net block is used.
