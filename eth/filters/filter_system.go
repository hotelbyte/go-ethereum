...
// Package filters implements an hotelbyte filtering system for block,
...
type subscription struct {
	...
	typ       Type
	created   time.Time
	logsCrit  hotelbyte.FilterQuery
	logs      chan []*types.Log
...
func (es *EventSystem) SubscribeLogs(crit hotelbyte.FilterQuery, logs chan []*types.Log) (*Subscription, error) {
...
func (es *EventSystem) subscribeMinedPendingLogs(crit hotelbyte.FilterQuery, logs chan []*types.Log) *Subscription {
	sub := &subscription{
		id:        rpc.NewID(),
...
func (es *EventSystem) subscribeLogs(crit hotelbyte.FilterQuery, logs chan []*types.Log) *Subscription {
	sub := &subscription{
		id:        rpc.NewID(),
...
func (es *EventSystem) subscribePendingLogs(crit hotelbyte.FilterQuery, logs chan []*types.Log) *Subscription {
	sub := &subscription{
		id:        rpc.NewID(),
