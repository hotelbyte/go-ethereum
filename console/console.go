...
import (
	...
	"github.com/hotelbyte/go-hotelbyte/internal/jsre"
	"github.com/hotelbyte/go-hotelbyte/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client  // RPC client to execute Hotelbyte requests through
...
// Welcome show summary of current Ghbc instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	// Print some generic Ghbc metadata
	fmt.Fprintf(c.printer, "Welcome to the Ghbc JavaScript console!\n\n")
	c.jsre.Run(`
