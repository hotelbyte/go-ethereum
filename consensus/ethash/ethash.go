...
// all blocks' seal as valid, though they still have to conform to the Hotelbyte
// consensus rules.
...
// still have to conform to the Hotelbyte consensus rules.
...
// they still have to conform to the Hotelbyte consensus rules.
