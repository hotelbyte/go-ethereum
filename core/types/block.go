...
// Package types contains data types related to Hotelbyte consensus.
package types
...
// DecodeRLP decodes the Hotelbyte
...
// EncodeRLP serializes b into the Hotelbyte RLP block format.
